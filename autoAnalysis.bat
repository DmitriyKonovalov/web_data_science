...
http POST http://localhost:8000/api/v1/analyses/1/load_file_data/ file_path="C:\data.csv" Authorization:"Token {TOK}"
...
http POST http://localhost:8000/api/v1/analyses/2/load_file_data/ file_path="C:\data.csv" Authorization:"Token {TOK}"
...
http POST http://localhost:8000/api/v1/analyses/3/load_file_data/ file_path="C:\data.csv" Authorization:"Token {TOK}"
...
http POST http://localhost:8000/api/v1/analyses/4/load_file_data/ file_path="C:\data.csv" Authorization:"Token {TOK}"
...
http POST http://localhost:8000/api/v1/analyses/5/load_file_data/ file_path="C:\data.csv" Authorization:"Token {TOK}"
